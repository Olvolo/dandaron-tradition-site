...
@else
    ...
    <x-app-layout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                        <h1 class="text-3xl md:text-4xl font-bold mb-4">{{ $article->title }}</h1>
                        <div class="text-sm text-gray-500 dark:text-gray-400 mb-6">
                            <span>Опубликовано в категории: <a href="#" class="text-blue-500 hover:underline">{{ $article->category->name }}</a></span>
